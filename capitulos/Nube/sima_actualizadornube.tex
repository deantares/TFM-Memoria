...
Google hace uso del popular servicio de autenticación OAuth, que permite la autorización de una API de modo estándar y simple. La gestión del modo de autenticación requiere el almacenaje y envío de credenciales de usuarios, basadas en un sistema de clave pública / privada \cite{oauth2-1}\cite{oauth2-2}.
