...
En la tabla se observa que el método que mejor resultados ofrece es \emph{LR} (regresión lineal) que consigue para todas las series ofrecer las mejores métricas de error en al menos 6 de las 7 métricas.
...
\caption[Valores predichos para 24 horas de las series A,B,C]{Valores predichos de las series (rectas punteadas) comparadas con los valores reales de las series.}
\label{fig:exp1_seriesSemana}
\end{SCfigure}
